...
<div className="p-8 text-2xl">
  ...
  <div className="bg-black dark:bg-gray-800 p-6 rounded-xl shadow-md 
    ...
    <img src="./portfolio/public/portfolio-logo.jpg" alt="Project 1" className="rounded-md mb-3" />
    ...
    <div className="bg-black dark:bg-gray-800 p-6 rounded-xl shadow-md 
                transform transition-transform duration-300 hover:scale-105">
        <img src="./portfolio/public/project2.jpg" alt="Project 2" className="rounded-md mb-3" />
    ...
    <div className="bg-black dark:bg-gray-800 p-6 rounded-xl shadow-md 
                transform transition-transform duration-300 hover:scale-105">
    <img src="./portfolio/public/project3.jpg" alt="Project 3" className="rounded-md mb-3" />
  ...
  <div className="bg-black dark:bg-gray-800 p-6 rounded-xl shadow-md 
                transform transition-transform duration-300 hover:scale-105">
    <img src="./portfolio/public/project4.jpg" alt="Project 4" className="rounded-md mb-3" />
    ...
    <div className="bg-black dark:bg-gray-800 p-6 rounded-xl shadow-md 
                transform transition-transform duration-300 hover:scale-105"> 
    <img src="./portfolio/public/project5.jpg" alt="Project 5" className="rounded-md mb-3" />
    ...
    <div className="bg-black dark:bg-gray-800 p-6 rounded-xl shadow-md 
                transform transition-transform duration-300 hover:scale-105">
    <img src="./portfolio/public/project6.jpg" alt="Project 6" className="rounded-md mb-3" />
    <h3 className="text-xl font-semibold mb-1 text-blue-600">
        Social Media App
    </h3>
    <p className="text-sm text-white dark:text-gray-300 mb-2">
